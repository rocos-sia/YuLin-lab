...
#         self.axis = np.array([[0.00467116, -0.99998366, -0.00329473, -0.09908802],
#                               [0.9998727, 0.00462033, 0.01527199, -0.17848115],
#                               [-0.01525652, -0.00336565, 0.99987795, 0.13417883],
#                               [0., 0., 0., 1.]])  # 转子轴心
#         # 放试管点
#         self.putA1 = [[0.54632959, -0.72825285, 0.4137291, -0.21228482],
#                       [0.83707784, 0.491681, -0.23989683, -0.10827232],
#                       [-0.02871719, 0.4773862, 0.8782242, 0.09781198],
#                       [0., 0., 0., 1.]]
#         self.putA2 = [[0.98433844, -0.17619486, 0.00576312, -0.10049784],
#                       [0.15359028, 0.84109087, -0.51862913, -0.03118209],
#                       [0.08653248, 0.51139175, 0.85497989, 0.105961],
#                       [0., 0., 0., 1.]]
#         self.putA3 = [[0.43065438, 0.78878537, -0.43858231, 0.02129687],
#                       [-0.90152189, 0.35315712, -0.25007663, -0.10777471],
#                       [-0.04236832, 0.50308815, 0.86319595, 0.1035237],
#                       [0., 0., 0., 1.]]
#         self.putB1 = [[-0.63968829, -0.42379848, -0.6412439, 0.16599224],
#                       [0.76417164, -0.26088433, -0.58989921, 0.06372954],
#                       [0.0827079, -0.86737202, 0.49073943, 0.20581889],
#                       [0., 0., 0., 1.]]
#         self.putB2 = [[-9.80898445e-01, -9.94178765e-04, -1.94518002e-01, -2.78976717e-02],
#                       [1.66727225e-01, -5.19408948e-01, -8.38102844e-01, 1.72235101e-01],
#                       [-1.00201167e-01, -8.54525223e-01, 5.09653186e-01, 1.98480842e-01],
#                       [0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 1.00000000e+00]]
#         self.putB3 = [[-0.43757298, 0.48644263, 0.75624299, -0.4114628],
#                       [-0.89911024, -0.2473922, -0.36110646, -0.02365675],
#                       [0.01143104, -0.83795624, 0.54561769, 0.18798543],
#                       [0., 0., 0., 1.]]
#         # 取试管点
#         self.getA1 = [[0.54633961, -0.72825603, 0.41371027, -0.25428025],
#                       [0.83707151, 0.49169136, -0.23989766, -0.083923],
#                       [-0.02871085, 0.47737067, 0.87823284, 0.00867541],
#                       [0., 0., 0., 1.]]
#         self.getA2 = [[0.98433274, -0.17622725, 0.00574627, -0.10112295],
#                       [0.15360305, 0.84105019, -0.51869132, 0.02658977],
#                       [0.08657464, 0.51144749, 0.85494228, 0.01073581],
#                       [0., 0., 0., 1.]]
#         self.getA3 = [[0.43066552, 0.78877369, -0.43859238, 0.0693088],
#                       [-0.90151697, 0.35316735, -0.25007995, -0.08040637],
#                       [-0.04235998, 0.50309928, 0.86318987, 0.00904363],
#                       [0., 0., 0., 1.]]
#         self.getB1 = [[-0.63969384, -0.42377987, -0.64125066, 0.03647382],
#                       [0.76416833, -0.26088605, -0.58990273, -0.03551902],
#                       [0.08269556, -0.86738059, 0.49072636, 0.12106141],
#                       [0., 0., 0., 1.]]
#         self.getB2 = [[-9.80891251e-01, -9.87517857e-04, -1.94554308e-01, -4.75453631e-02],
#                       [1.66757364e-01, -5.19387527e-01, -8.38110123e-01, 7.46201040e-03],
#                       [-1.00221432e-01, -8.54538250e-01, 5.09627357e-01, 1.16328533e-01],
#                       [0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 1.00000000e+00]]
#         self.getB3 = [[-0.43757921, 0.48639574, 0.75626954, -0.25839097],
#                       [-0.89910564, -0.24748811, -0.36105219, -0.09915442],
#                       [0.01155347, -0.83795514, 0.5456168, 0.10924456],
#                       [0., 0., 0., 1.]]
#
#         # 中间点
#         self.put_middleA = []
...
#                                      [0., 0., 0., 1.]])
#         # 看aruco点
#         self.watch_aruco_pose = np.array([[9.99985496e-01, 4.70160030e-03, 2.62745153e-03, -1.05086172e-01],
#                                           [-4.70224940e-03, 9.99988915e-01, 2.40921746e-04, -5.41658428e-02],
#                                           [-2.62628969e-03, -2.53273184e-04, 9.99996519e-01, 1.74968831e-01],
#                                           [0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 1.00000000e+00]])
#         self.pose_aruco2 = []
#         self.mark2camera = []
#
...
#         # 计算示教点
#         self.pose_aruco2 = duco_cobot.get_tcp_pose()
#         # self.pose_aruco2 = [-0.5798445343971252, 0.04713998734951019, 0.8269234895706177, -3.126620054244995,
#         #                     -0.005690203048288822, 1.5656660795211792]
...
#         self.mark2camera = [-3.01177464, -0.13664918, 1.60957694]  # 取试管比较的旋转角度
#         # 中间点
...
if __name__ == '__main__':
    ...
    aruco_pose = [-0.5797823071479797, 0.046758659183979034, 0.8268461227416992, -3.126473903656006,
                  -0.005428679753094912, 1.5656073093414307]

    A1 = [-0.6577167510986328, -0.05674612894654274, 0.6928178071975708, -3.1240832805633545, -0.005093305371701717, 1.5707988739013672]
    # A2 = [-0.5537988543510437, -0.05360905081033707, 0.816024124622345, -2.5868208408355713, 0.0857829675078392, 1.412726640701294]
    # A3 = [-0.6599640846252441, 0.11730573326349258, 0.8199104070663452, -2.6102607250213623, -0.05757338926196098, 2.691133737564087]
    # B1 = [-0.671795129776001, 0.10141169279813766, 0.7230322360992432, 2.14272403717041, -0.013568880036473274, -0.545673131942749]
    # B2 = [-0.5701283812522888, -0.050581831485033035, 0.7138047218322754, 2.101604461669922, -0.000644760497380048, -1.5668120384216309]
    # B3 = [-0.6817607879638672, -0.20996646583080292, 0.7189318537712097, 2.1383261680603027, -0.0007463099318556488, -2.693326473236084]

    A1 = get_T(aruco_pose, A1)
    # A2 = get_T(aruco_pose, A2)
    # A3 = get_T(aruco_pose, A3)
    # B1 = get_T(aruco_pose, B1)
    # B2 = get_T(aruco_pose, B2)
    # B3 = get_T(aruco_pose, B3)
    ...
    # duco_cobot.movel(A1, 0.2, 0.2, 0, [], "", "", True)
    #
    ...
    # watch_aruco_j = [0.07509901374578476, 0.07366134226322174, -2.2143123149871826, 2.140777826309204,
    #                       1.4934604167938232, -0.7687444686889648]
    # duco_cobot.movej(watch_aruco_j, 20, 10, 0, True)
    # aruco.mark()
    # pose_j = duco_cobot.get_actual_joints_position()
    # pose = duco_cobot.get_tcp_pose()
    # print("joint", pose_j)
    # print("pose", pose)
    # mark2camera = np.array([[0.27921038, 0.9559346, -0.09072269, -0.02314434],
    #                              [0.95787014, -0.28389802, -0.04343624, 0.1882538],
    #                              [-0.0672782, -0.07477271, -0.99492848, 1.35911388],
    #                              [0., 0., 0., 1.]])
    #
    # print(T.T2euler(mark2camera))
