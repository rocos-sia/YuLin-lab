...
midpose = [1.668006181716919, 0.10159657150506973, -1.3602924346923828, -0.30960047245025635, 1.5602844953536987, -0.629919171333313]
header = ['x', 'y', 'z', 'r', 'p', 'y']
# csvflag = 1
speedl = 0.7
speedj = 70
...
class testtube(object):
    def __init__(self):
        ...
        # 离心机操作：试管架取试管至离心机
        self.tube_getA1 = [-0.02102518640458584, -0.5755000114440918-0.0007, 0.5018289187431335-0.001, -3.1415581703186035,
                           -1.5060706573422067e-05, -3.1415655612945557]
        self.tube_getA2 = [-0.08533629775047302, -0.575955331325531-0.0007, 0.5018990303993225-0.0003, 3.141589641571045,
                           -2.3479329684050754e-05, -3.1415669918060303]
        self.tube_getA3 = [-0.15150830149650574, -0.5760762691497803-0.0007, 0.5018643902778625-0.0005, -3.1415746212005615,
        ...
        self.tube_putA3 = [-0.08533278107643127-0.065, -0.5764991173744202, 0.65245521068573, 3.141589403152466,
                           -1.6222867998294532e-05, -3.1415767669677734]
        self.tube_putB1 = [0.051635488867759705+0.065+0.001, -0.8761548399925232, 0.34584997177124023, 1.5708034038543701, 5.354250788514037e-06, -2.6035778522491455]
        self.tube_putB2 = [0.051635488867759705+0.0005, -0.8761548399925232, 0.34584997177124023, 1.5708034038543701, 5.354250788514037e-06, -2.6035778522491455]
        self.tube_putB3 = [0.051635488867759705-0.065+0.0008, -0.8761548399925232-0.0005, 0.34584997177124023, 1.5708034038543701, 5.354250788514037e-06, -2.6035778522491455]
        # 放盖（试管上）
        self.lid_putA1 = [-0.15130600790977478+0.13+0.0008, -0.5780059122657776+0.0005, 0.5333243451118469+0.01, 3.141587018966675,
                          -9.225173926097341e-06, 3.1415891647338867]
        self.lid_putA2 = [-0.15130600790977478+0.065, -0.5780059122657776+0.0005, 0.5333243451118469+0.01, 3.141587018966675,
                          -9.225173926097341e-06, 3.1415891647338867]
        self.lid_putA3 = [-0.15130600790977478, -0.5780059122657776, 0.5333243451118469+0.01, 3.141587018966675,
                          -9.225173926097341e-06, 3.1415891647338867]
        self.lid_putB1 = [-0.15104584531784058+0.13-0.001, -0.6420934796333313, 0.5335747442245483+0.01, -3.1415863037109375,
                          -1.5198091205093078e-05, -3.141561985015869]
        self.lid_putB2 = [-0.15104584531784058+0.065-0.001, -0.6420934796333313-0.0005, 0.5335747442245483+0.01, -3.1415863037109375,
                          -1.5198091205093078e-05, -3.141561985015869]
        ...
        self.lid_getA2 = [-0.0853310078382492, -0.5780207741737366-0.0003, 0.5019515224456787-0.001, -3.141307830810547,
        ...
        self.lid_getB1 = [-0.019964830949902534, -0.644310509967804+0.001, 0.5020496543884277-0.001, -3.141547203063965,
                          -1.1541584171936847e-05, -3.141584873199463]
        self.lid_getB2 = [-0.08533148467540741, -0.6442565247535706+0.001, 0.501956396484375-0.001, -3.1414411067962646,
                          -6.6090374275518116e-06, -3.1415536403656006]
        self.lid_getB3 = [-0.08533148467540741-0.065, -0.6442565247535706+0.001, 0.501956396484375-0.001, -3.1414411067962646,
                          -6.6090374275518116e-06, -3.1415536403656006]
        # 放盖（平台上）
        ...
        # 取盖（平台上）
        self.lid_get_A1 = [0.17644771933555603, -0.6428622437477112-0.001, 0.3194399272918701+0.012, 3.1415696144104004,
...
class getsample(object):
    def __init__(self):
        ...
        self.getC2_up = []
        # 放试管
        self.putA1 = [2.3517422676086426, -0.28223419189453125+0.0005, -1.8454258441925049, -1.0169093608856201, 0.7814416885375977, -0.7715128064155579]
        self.putA2 = [2.286440134048462, -0.3664233684539795+0.0005, -1.7275609970092773, -1.051507830619812, 0.7162235379219055, -0.7708176970481873]
        self.putB1 = [2.276193618774414, -0.23610690236091614+0.0008, -1.9065214395523071, -1.0024445056915283, 0.7059170603752136, -0.7713210582733154]
        self.putB2 = [2.2135400772094727, -0.32462239265441895+0.0005, -1.7869548797607422, -1.0342985391616821, 0.6432875394821167, -0.770530104637146]
...
class seperation(object):
    def __init__(self):
        # 倾倒点
        self.middle = [2.108090877532959, -0.007148286327719688, -1.6144897937774658, -1.515860676765442, 0.548012912273407, 2.3568851947784424]
        # 倾倒取试管
        self.getA1 = [0.2264304757118225, -0.5757653713226318-0.0003, 0.19310222566127777, -1.5707921981811523, -2.4697665139683522e-05, 1.5622894763946533]
        self.getA2 = [-0.158240407705307, -0.34018659591674805, 0.1985221654176712, -1.5707848072052002, -2.0720669908769196e-06, -2.8423726558685303]
        self.getA3 = [-0.2237684279680252, -0.34005701541900635, 0.1985214352607727, -1.570785641670227, -6.666150966339046e-06, -2.84234881401062]
        self.getB1 = [0.22605517506599426, -0.6407598257064819-0.0002, 0.1931076943874359, -1.5707927942276, -2.5389628717675805e-05, 1.5622886419296265]
        self.getB2 = [0.002634721575304866, -0.8690693378448486-0.0003, 0.19239483773708344, -1.5724000930786133, 0.0002806083357427269, 0.36598125100135803]
        self.getB3 =  [-0.06238335371017456, -0.869005024433136, 0.19238193333148956, -1.5723758935928345, 0.00028370501240715384, 0.36598101258277893]
        # 倾倒放试管
        self.putA1_j = [2.349848747253418, -0.29376301169395447, -1.8532036542892456, -0.9978065490722656, 0.7880449891090393, 2.360708236694336]
        self.putA2_j = [1.450636386871338, 0.4052288830280304, -2.4930293560028076, -1.0543361902236938, -1.9895987510681152, 2.354236602783203]
        self.putA3_j = [1.2207189798355103, 0.28694459795951843, -2.425126791000366, -1.004805326461792, -2.219588041305542, 2.3537333011627197]
        self.putB1_j = [2.284390926361084, -0.3769814670085907, -1.7352548837661743, -1.0331840515136719, 0.722611129283905, 2.3614392280578613]
        self.putB2_j = [1.782443642616272, -0.7671159505844116, -1.0987367630004883, -1.2747859954833984, 1.417192816734314, 2.3608040809631348]
        self.putB3_j = [1.7160149812698364, -0.7656897902488708, -1.101097583770752, -1.2740429639816284, 1.350776195526123, 2.3607561588287354]
        # 倾倒路点
...
class drying(object):
    def __init__(self):
        ...
        self.jia_j=[2.4158217906951904, -0.5467020869255066, -1.7657907009124756, -0.8321366310119629, 0.8482015517616272, 0.802851456]
...
class putsample(object):
    def __init__(self):
        ...
        self.getB2_jia = [0.1605851650238037, -0.6422537565231323, 0.19780628383159637, 1.5708760023117065,
                      -3.7600224459310994e-05, -1.5821495056152344]
        self.getC1_jia = [0.1605851650238037 + 0.065, -0.6422537565231323 + 0.065, 0.19780628383159637, 1.5708760023117065,
                      -3.7600224459310994e-05, -1.5821495056152344]
